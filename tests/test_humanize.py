...
def test_uniform_rhythm_detected():
    ...
    text = ("The team builds tools for modern sales work. The product helps people "
            "close deals much faster. The company culture values remote work deeply. "
            "The role focuses on customer growth outcomes. The mission speaks to my "
